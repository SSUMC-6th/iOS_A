...
class UsingExtensionUITableViewController: UITableViewController {
    var mockUpData = ["Sample 1", "Sample 2", "Sample 3"]
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "Another Sample Table View"
    }
}

// MARK: - Table view data source

extension UsingExtensionUITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = mockUpData[indexPath.row]
